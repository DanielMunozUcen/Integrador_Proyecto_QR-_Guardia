...
document.addEventListener('DOMContentLoaded', function() {
  const enlacesEliminar = document.querySelectorAll('.eliminar-usuario');
    ...
    enlace.addEventListener('click', function(event) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location = enlace.href; // Redirige si se confirma la eliminación
        }
      });
    });
  });
